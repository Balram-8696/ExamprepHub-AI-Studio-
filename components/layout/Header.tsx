...
import { LogIn, User as UserIcon, Menu, User as UserViewIcon, Search, Sun, Moon, Bell, Newspaper, MessageSquare, MessageCircle } from 'lucide-react';
...
const Header: React.FC<HeaderProps> = ({ 
    ...
    notifications, onOpenChat, onMarkAsRead, onNotificationClick
}) => {
    ...
    useEffect(() => {
        const handler = setTimeout(() => { onSearch(localSearchQuery); }, 300);
